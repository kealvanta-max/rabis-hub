...
export const HeroHighlight = ({
  ...
  return (
    <div
      className={cn(
        "relative h-full flex items-center bg-navy-dark justify-center w-full group",
        containerClassName
      )}
...
export const Highlight = ({
  ...
  return (
    <motion.span
      ...
      className={cn(
        `relative inline-block pb-1 px-1 rounded-lg bg-gradient-to-r from-primary/30 to-primary/10`,
        className
      )}
    >
      {children}
